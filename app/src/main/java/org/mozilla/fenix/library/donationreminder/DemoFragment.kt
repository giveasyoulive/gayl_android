...
package org.mozilla.fenix.library.donationreminder
...
class DemoFragment : Fragment(R.layout.onboarding_donationreminder_demo) {
    ...
    // Stop the demo from being presented again
    ...
    private fun nextStep() {
        ...
        when (page) {
            ...
            6 -> {
                ...
                // Navigate to the app welcome page
                nav("https://www.giveasyoulive.com/app-welcome")
    ...
    private fun slideLeft(img: ImageView, interval: Long) {
        var animation = TranslateAnimation(500.0f, 0.0f, 0.0f, 0.0f)
    ...
    /**
     * Navigate to page on browser
     */
    private fun nav(url: String) {

        // Save the fact that the user has completed the demo pages
        donationReminderDemo.finish()

        // Pop back to the home fragment
        if (!findNavController().popBackStack(R.id.browserFragment, false)) {
            findNavController().popBackStack(R.id.homeFragment, false)
        }

        // Start the sign in or signup process
